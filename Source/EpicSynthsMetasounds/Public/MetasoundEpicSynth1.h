...
namespace Audio
{
	...
	public:
		...
		void SetLFOPatch(const int32 InLFOIndex, const EMetasoundSynthLFOPatchType InPatchType);
		void SetEnvModPatch(const EMetasoundSynthModEnvPatch InPatchType);
		void SetEnvModBiasPatch(const EMetasoundSynthModEnvBiasPatch InPatchType);
	...
	protected:
		...
		FPatchSource GetPatchSource(EMetasoundSynth1PatchSource PatchSource);
		void GetPatchDestinations(EMetasoundSynth1PatchDestination PatchDestination, TArray<FPatchDestination>& Destinations);
		...
		FPatch LFOPatches[NumLFOs][(int32)EMetasoundSynthLFOPatchType::Count];
		FPatch ModEnvPatches[(int32)EMetasoundSynthModEnvPatch::Count];
		FPatch ModEnvBiasPatches[(int32)EMetasoundSynthModEnvBiasPatch::Count];

		TMap<int32, TSharedPtr<FPatch>> DynamicPatches;

		EMetasoundSynthLFOPatchType CurrentPatchType[NumLFOs];
		EMetasoundSynthModEnvPatch CurrentModPatchType;
		EMetasoundSynthModEnvBiasPatch CurrentModBiasPatchType;
	...
	public:
		...
		/// Filter setting
		void SetFilterAlgorithm(const EMetasoundSynthFilterAlgorithm FilterAlgorithm);
		...
		void SetLFOPatch(const int32 LFOIndex, const EMetasoundSynthLFOPatchType InRouteType);
		...
		void SetModEnvPatch(const EMetasoundSynthModEnvPatch InPatchType);
		void SetModEnvBiasPatch(const EMetasoundSynthModEnvBiasPatch InPatchType);
	...
	protected:
		...
		EMetasoundSynthFilterAlgorithm FilterAlgorithm;
